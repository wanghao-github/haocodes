...
coefficient_matrix = np.zeros((10,10))
...
for i in range(10):
    ...
    coefficient_matrix[i][0] = -1 * alpha_1
    coefficient_matrix[i][1] = -1 * beta_1
    coefficient_matrix[i][2] = -1 * 2 * alpha_2 * beta_2
    coefficient_matrix[i][3] = -1 * alpha_3 * alpha_4 * beta_3
    coefficient_matrix[i][4] = -1 * alpha_2 * beta_1 * beta_2
    coefficient_matrix[i][5] = -1 * 2 * alpha_3 * alpha_4 * beta_3 * beta_4
    coefficient_matrix[i][6] = 1

# total_energy = np.mat('-278.64331,-278.73402,-278.718,-278.33114,-278.32958,-278.44735').T
